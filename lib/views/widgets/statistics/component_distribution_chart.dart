// lib/views/widgets/statistics/component_distribution_chart.dart
import 'package:flutter/material.dart';
import 'package:fl_chart/fl_chart.dart';

class ComponentDistributionChart extends StatelessWidget {
  final Map<String, int> distribution;

  const ComponentDistributionChart({super.key, required this.distribution});
